                ...
                <div className="flex flex-col">
                    <div>
                        <div className="flex flex-row">
                            <FontAwesomeIcon icon={faMessage} className="mr-4" size="2x" />
                            ...
                            <div className="hero-content flex-col sm:flex-row">
                                <div>
                                    <div className="w-auto sm:w-150">
                                        <h1 className="text-3xl font-bold text-center">Supitcha Kaewkham</h1>
                                        ...
                                        <div className="flex flex-col ... items-center ">
                                            <div className="text-xl mb-3 badge badge-neutral badge-outline font-bold p-6 w-full justify-start sm:w-1/3">
                                                <a href="/resume.pdf" target="_blank" rel="noreferrer" className="flex flex-row items-center gap-3 ">
                                                    <FontAwesomeIcon icon={faFile} className="w-10 h-10" color="grey" />
                                                    <p>Resume</p></a>
                                            </div>
                                            <div className="text-xl mb-3 badge badge-neutral badge-outline font-bold p-6 w-full justify-start sm:w-1/3">
                                            ...
                                            <div className="text-xl mb-3 badge badge-neutral badge-outline font-bold p-6 w-full justify-start sm:w-1/3">
                                                <a href="https://github.com/auhmaugmaufm" target="_blank" className="flex flex-row items-center gap-3">
                                                    <FontAwesomeIcon icon={faSquareGithub} className="w-10 h-10" color="black" />
                                                    <p>Github</p>
                                                </a>
                                            </div>
                                            <div className="text-xl mb-3 badge badge-neutral badge-outline font-bold p-6 w-full justify-start sm:w-1/3">
                                                <a href="https://www.linkedin.com/in/supitcha-kaewkham-8212b2348/" target="_blank" className="flex flex-row items-center gap-3">
                                                    <FontAwesomeIcon icon={faLinkedin} className="w-10 h-10" color="navy" />
                                                    <p>LinkedIn</p>
                                                </a>
                                            </div>
                                        </div>
